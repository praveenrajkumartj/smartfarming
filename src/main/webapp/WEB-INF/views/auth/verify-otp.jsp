<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <title>🔢 OTP VERIFICATION - AGROPLANTER</title>
        ...
        <body>
            ...
            <div class="auth-card-premium">
                <div class="text-center mb-4">
                    ...
                    <h2 class="fw-900 text-white mb-2">VERIFY OTP</h2>
                    <p class="text-white-50 x-small text-uppercase fw-bold letter-spacing-1">Enter code sent to:
                        ${email}
                    </p>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/recovery/verify-otp" method="post">
                    <input type="hidden" name="email" value="${email}" />
                    <div class="auth-input-group">
                        <label class="auth-label">6-DIGIT VERIFICATION CODE</label>
                        <input type="text" name="otp" class="form-control auth-input" placeholder="000000" maxlength="6"
                            pattern="\d{6}" required />
                    </div>

                    <button type="submit" class="btn btn-auth">VERIFY OTP →</button>
                </form>

                <div class="text-center mt-5 pt-3 border-top border-white border-opacity-10">
                    <p class="text-white-50 small">WRONG EMAIL? <a href="${pageContext.request.contextPath}/recovery"
                            class="text-white fw-bold text-decoration-none">TRY AGAIN</a></p>
                </div>
            </div>
