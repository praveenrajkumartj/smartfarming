    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
            ...
            <head>
                ...
                <title>🏢 Institutional Deals - AGROPLANTER Admin</title>
                    ...
                    <aside class="sidebar sidebar-premium" id="sidebar">
                        ...
                        <nav class="sidebar-nav px-3 py-4">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/b2b-deals"
                                class="sidebar-nav-item active mb-2"><span class="nav-icon">🏢</span> B2B Deals</a>
                    ...
                    <div class="main-content">
                        <header class="top-nav">
                            <div class="top-nav-left">
                                ...
                                <span class="page-title">🏢 Institutional B2B Deal Matrix</span>
                            </div>
                            <div class="top-nav-right">
                                <div class="user-info"
                                    style="gap: 15px; cursor: pointer; display: flex; align-items: center;"
                                    onclick="window.location.href='${pageContext.request.contextPath}/admin/b2b-deals'">
                        ...
                        <div class="page-body">
                            <div class="card overkill-card">
                                <div class="card-header border-0 d-flex justify-content-between align-items-center">
                                    <span class="card-title">🏭 Corporate Bulk Procurement Registry</span>
                                    <div class="badge bg-primary bg-opacity-10 text-primary fw-950 px-4 py-2 rounded-pill uppercase"
                                        ...
                                        ${fn:length(deals)} B2B CONTRACTS</div>
                                </div>
                                    ...
                                    <table class="v3-data-table mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>TIMESTAMP</th>
                                                <th>GROSS VALUE</th>
                                                <th>COMMISSION (ROI)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach var="deal" items="${deals}">
                                                <tr>
                                                    <td class="ps-4 small text-muted font-monospace">#${deal.id}</td>
                                                    <td>
                                                        <div class="text-white fw-bold">${deal.listing.cropName}</div>
                                                    </td>
                                                    <td>
                                                        <div class="text-white-50 small">${deal.farmer.fullName}</div>
                                                    </td>
                                                    <td>
                                                        <div class="text-white-50 small">${deal.buyer.fullName}</div>
                                                    </td>
                                                    <td>
                                                        <div class="text-muted small">${deal.timestamp}</div>
                                                    </td>
                                                    <td><span class="text-success fw-bold">₹${deal.amount}</span></td>
                                                    <td><span class="text-warning fw-bold">₹${deal.commission}</span>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            <c:if test="${empty deals}">
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted py-5 opacity-50">
                                                        No institutional B2B contracts recorded.
                                                    </td>
                                                </tr>
                                            </c:if>
                                        </tbody>
