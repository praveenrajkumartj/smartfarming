        ...
        <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
            <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
                ...
                <head>
                    ...
                    <title>Superuser Identity - AGROPLANTER Admin</title>
                    ...
                    <style>
                        ...
                        .v3-terminal-input:focus {
                            ...
                            box-shadow: 0 0 25px rgba(124, 58, 237, 0.1) !important;
                            ...
                            <nav class="sidebar-nav px-3 py-4">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/profile"
                                    class="sidebar-nav-item active mb-2"><span class="nav-icon"
                                        style="color:#7c3aed;">👤</span> Identity Profile</a>
                                ...
                                <div class="top-nav-left d-flex align-items-center gap-3">
                                    ...
                                    <div class="page-title">
                                        ...
                                        <span class="v3-page-subtitle text-purple-400 uppercase"
                                            style="letter-spacing: 1px; font-weight: 800;">👤 ROOT ACCESS | NODE:
                                            ${user.fullName.toUpperCase()} | STATUS: SECURED</span>
                                    </div>
                                </div>
                                <div class="top-nav-right">
                                    <div class="user-info"
                                        style="gap: 15px; cursor: pointer; display: flex; align-items: center;"
                                        onclick="window.location.href='${pageContext.request.contextPath}/admin/profile'">
                            ...
                            <div class="page-body px-5 py-5">
                                <c:if test="${not empty successMessage}">
                                    <div class="alert alert-success border-0 rounded-4 mb-5 text-center fw-900 uppercase"
                                        style="background: rgba(124, 58, 237, 0.1); color: #7c3aed; letter-spacing: 1px;">
                                        ${successMessage}</div>
                                </c:if>
                                ...
                                <div class="row g-4 mb-5">
                                    <div class="col-md-4">
                                        <div class="v3-nexus-panel p-4 text-center">
                                            <span class="v3-identity-label">IDENTITIES MANAGED</span>
                                            <div class="h2 fw-950 text-white m-0">${totalUsers}</div>
                                            <div class="x-small text-purple-400 fw-800 uppercase mt-1">Global Active
                                                Nodes</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="v3-nexus-panel p-4 text-center">
                                            <span class="v3-identity-label">SYSTEM REVENUE</span>
                                            <div class="h2 fw-950 text-success m-0">₹
                                                <fmt:formatNumber value="${totalRevenue}" pattern="#,###" />
                                            </div>
                                            <div class="x-small text-success fw-800 uppercase mt-1">Platform Commissions
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="v3-nexus-panel p-4 text-center">
                                            <span class="v3-identity-label">ENCRYPTION LEVEL</span>
                                            <div class="h2 fw-950 text-info m-0">ROOT</div>
                                            <div class="x-small text-white-50 fw-800 uppercase mt-1">Zero Trust
                                                Architecture</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="v3-profile-nexus">
                                    <h3 class="fw-950 text-white mb-5" style="letter-spacing: -1px;">✏️ Edit Superuser
                                        Identity</h3>
                                    <form action="${pageContext.request.contextPath}/admin/profile/update" method="post"
                                        ...
                                        <div class="d-flex align-items-center gap-4 mb-5 p-4 rounded-4"
                                            ...
                                            <div class="flex-grow-1">
                                                <span class="v3-identity-label">ROOT AVATAR (BIO-METRIC)</span>
                                                <input type="file" name="profileImage"
                                                    class="form-control v3-terminal-input" accept="image/*" />
                                                <p class="text-white-50 x-small mt-2 mb-0 fw-600">High-fidelity renders
                                                    required for root level authentication.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-4 opacity-75">
                                            <span class="v3-identity-label">SECURE UID (EMAIL ADDRESS - READ
                                                ONLY)</span>
                                        ...
                                        <div class="row g-4 mb-5">
                                            <div class="col-md-6">
                                                <span class="v3-identity-label">OPERATIONS STATE</span>
                                                <input type="text" name="state" class="form-control v3-terminal-input"
                                                    value="${user.state}" />
                                            </div>
                                            <div class="col-md-6">
                                                <span class="v3-identity-label">HEADQUARTER CITY NODE</span>
                                        ...
                                        <div class="text-end">
                                            <button type="submit" class="btn btn-quantum px-5"
                                                style="background: linear-gradient(135deg, #7c3aed, #4f46e5); border: none;">RE-AUTHORIZE
                                                IDENTITY</button>
                                        </div>
                                    </form>
                                </div>
