    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
            ...
            <head>
                ...
                <title>Buyer Profile - Smart Farming Platform</title>
                ...
                <div class="dashboard-layout">
                    ...
                    <aside class="sidebar" id="sidebar">
                        ...
                        <nav class="sidebar-nav">
                            ...
                            <a href="${pageContext.request.contextPath}/buyer/profile" class="active"><span
                    ...
                    <div class="main-content">
                        ...
                        <div class="page-body">
                            ...
                            <div class="card" style="max-width: 600px; margin: 24px auto 0;">
                                ...
                                <div class="card-body">
                                    <div
                                        style="display: flex; justify-content: space-between; align-items: center; background: rgba(14,165,233,0.05); border: 1px solid rgba(14,165,233,0.2); padding: 16px; border-radius: 8px;">
                                        <div>
