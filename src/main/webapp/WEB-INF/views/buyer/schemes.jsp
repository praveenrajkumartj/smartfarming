    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
            ...
            <head>
                ...
                <title>Govt Schemes - Smart Farming Platform</title>
                ...
                <div class="dashboard-layout">
                    <aside class="sidebar" id="sidebar">
                        ...
                        <nav class="sidebar-nav">
                            ...
                            <a href="${pageContext.request.contextPath}/buyer/schemes" class="active"><span
                    ...
                    <div class="main-content">
                        <header class="top-nav">
                            <div class="top-nav-left">
                                ...
                                <span class="page-title">✨ Government Schemes</span>
                            </div>
                        </header>
                        <div class="page-body">
                                    ...
                                    <form action="${pageContext.request.contextPath}/buyer/schemes" method="get">
                                        <div style="display:flex;gap:12px;">
                                            <input type="text" name="search" class="form-control"
                                                placeholder="Search schemes..." value="${search}" style="flex:1;" />
