    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
            ...
            <head>
                ...
                <title>🚜 Hardware Security - AGROPLANTER</title>
                            ...
                            <div class="top-nav-left d-flex align-items-center gap-3">
                                ...
                                <div class="page-title">
                                    <h1 class="m-0 fw-900 text-white"
                                        ...
                                        <span style="color: #3b82f6;">🚜</span> Hardware Security
                                    </h1>
                                    <span class="v3-page-subtitle text-primary">
                                        📡 KINETIC SHIELDING ACTIVE | MECHANIZATION SAFETY STANDARDS
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="page-body px-5 py-5">
                            <div class="safety-hero mb-5">
                                <div class="badge bg-primary bg-opacity-10 text-primary fw-900 px-3 py-1 mb-3"
                                    ...
                                    INDUSTRIAL SAFETY V3</div>
                                <h2 class="text-white fw-900" style="font-size: 3.5rem; letter-spacing: -2px;">Heavy
                                    Machinery &<br>Tractor Safety Protocols</h2>
                                <p class="text-white-50 mt-3 fs-5">Advanced protocols for handling high-torque
                                    agricultural hardware and kinetic energy systems.</p>
                            </div>

                            <div class="row g-5">
                                <div class="col-lg-8">
                                    <span class="trust-label uppercase mb-4 d-block">🌓 CORE SAFETY SEQUENCES</span>

                                    <div class="protocol-node d-flex gap-4">
                                        <div class="node-digit">01</div>
                                        <div>
                                            <h5 class="text-white fw-900">PTO Kinetic Shielding</h5>
                                            <p class="text-white-50 small m-0">Ensure all Power Take-Off (PTO) shafts
                                                are fully shielded. Never approach a rotating shaft. Terminate engine
                                                before inspection.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="protocol-node d-flex gap-4">
                                        ...
                                        <div>
                                            <h5 class="text-white fw-900">Roll-Over Protection (ROPS)</h5>
                                            <p class="text-white-50 small m-0">Maintain ROPS integrity. Always utilize
                                                seatbelts when operating tractors on non-level terrain to neutralize
                                    ...
                                    <div class="protocol-node d-flex gap-4">
                                        ...
                                        <div>
                                            <h5 class="text-white fw-900">Hydraulic Stability</h5>
                                            <p class="text-white-50 small m-0">Check for pinhole leaks using cardboard,
                                                not hands. High-pressure hydraulic fluid can penetrate skin (fluid
                                                injection injury).</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <span class="trust-label uppercase mb-4 d-block" style="color: #3b82f6;">🛠️
                                        MAINTENANCE BENCHMARKS</span>
                                    <div class="protocol-node">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="gear-pill mb-2">LOCK-OUT/TAG-OUT</div>
                                            </div>
                                            <div class="col-12">
                                                <div class="gear-pill mb-2">TIRE PRESSURE CALIBRATION</div>
                                            </div>
                                            <div class="col-12">
                                                <div class="gear-pill mb-2">BRAKE FLUID TELEMETRY</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
